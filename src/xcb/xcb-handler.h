...
/* Event type constants - matching XCB constants */
...
#define XCB_EVENT_TYPE_CONFIGURE_NOTIFY 22
#define XCB_EVENT_TYPE_CONFIGURE_REQUEST 23
#define XCB_EVENT_TYPE_GRAVITY_NOTIFY  26
#define XCB_EVENT_TYPE_RESIZE_REQUEST  27
#define XCB_EVENT_TYPE_CIRCULATE_NOTIFY 28
#define XCB_EVENT_TYPE_CIRCULATE_REQUEST 29
...
#define XCB_EVENT_TYPE_SELECTION_NOTIFY 31
#define XCB_EVENT_TYPE_COLORMAP_NOTIFY  32
#define XCB_EVENT_TYPE_CLIENT_MESSAGE   33
#define XCB_EVENT_TYPE_MAPPING_NOTIFY   34
 ...
 *
 * Note: Returns first handler. Use xcb_handler_lookup_next() to iterate.
 */
 ...
 *
 * Calls all handlers registered for the event's response_type.
 * The event is NOT freed - caller retains ownership.
 */
