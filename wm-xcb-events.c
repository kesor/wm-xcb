...
const char*
xinput_event_type_name(uint16_t event_type)
{
...
void
handle_xinput_event(xcb_ge_generic_event_t* event)
{
...
void
handle_xinput_raw_event(xcb_ge_generic_event_t* event)
{
...
void
handle_ge_generic(xcb_ge_generic_event_t* event)
{
